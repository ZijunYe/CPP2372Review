...
int main()
{
    ...
    //how to acess the key and value by iterator 
    for (it = m.begin(); it != m.end(); it++) {
         // each element of the iterator is a pair
        // with a "first"(key) and a "second"(value)
        total += it->second; //gives the value of the key 
    ...
    //method count :to check the key whether in the map or not 
    m.count("apple"); // count only will return 0 or 1 
